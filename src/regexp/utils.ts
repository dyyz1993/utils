/** @see https://github.com/XmanLin/MyUtils/blob/master/check/checkUtil.js */
 ...
 * 验证必须带端口号的网址(或ip)
 * @param { string } value
 * @example isHttpAndPort
 * isHttpAndPort('http://baidu.com:80/xx') //=> true
 * isHttpAndPort('http://baidu.com:80') //=> true
 * isHttpAndPort('ftp://baidu.com:80/xx') //=> true
 * isHttpAndPort('https://baidu.com:80/xx') //=> true
 * isHttpAndPort('https://baidu.com/xx') //=> false
 * 
 */
 ...
 *  @param { string } value
 */
export const isSubnetMask = (value: string) => /^(?:\d{1,2}|1\d\d|2[0-4]\d|25[0-5])(?:\.(?:\d{1,2}|1\d\d|2[0-4]\d|25[0-5])){3}$/g.test(value);

/**
 *  验证linux隐藏文件路径
 *  @param { string } value
 */
export const isLinuxHiddenFilePath = (value: string) => /^\/(?:[^\/]+\/)*\.[^\/]*/g.test(value);

/**
 *  验证linux文件夹路径
 *  @param { string } value
 */
export const isLinuxFolderPath = (value: string) => /^\/(?:[^\/]+\/)*[^\/]+$/g.test(value);

/**
 *  验证linux文件路径
 *  @param { string } value
 */
export const isLinuxFilePath = (value: string) => /^\/(?:[^/]+\/)*[^/]+$/g.test(value);

/**
 *  验证window"文件夹"路径
 *  @param { string } value
 */
export const isWindowsFolderPath = (value: string) => /^[a-zA-Z]:\\(?:\w+\\?)*$/g.test(value);

/**
 *  验证window下"文件"路径
 *  @param { string } value
 */
export const isWindowsFilePath = (value: string) => /^[a-zA-Z]:\\(?:\w+\\)*\w+\.\w+$/g.test(value);

/**
 *  验证股票代码(A股)
 *  @param { string } value
 */
export const isAShare = (value: string) => /^(s[hz]|S[HZ])(000[\d]{3}|002[\d]{3}|300[\d]{3}|600[\d]{3}|60[\d]{4})$/g.test(value);
 ...
 *  @param { string } value
 */
export const isHtmlComments = (value: string) => /^<!--[\s\S]*?-->$/g.test(value);

/**
 *  验证md5格式(32位)
 *  @param { string } value
 */
export const isMD5 = (value: string) => /^([a-f\d]{32}|[A-F\d]{32})$/g.test(value);
 ...
 * @param { string } value
 */
export const isBase64 = (value: string) => /^\s*data:(?:[a-z]+\/[a-z0-9-+.]+(?:;[a-z-]+=[a-z0-9-]+)?)?(?:;base64)?,([a-z0-9!$&',()*+;=\-._~:@\/?%\s]*?)\s*$/i.test(value);
 ...
 * @param { string } value
 */
export const isLicensePlateNumberNER = (value: string) => /[京津沪渝冀豫云辽黑湘皖鲁新苏浙赣鄂桂甘晋蒙陕吉闽贵粤青藏川宁琼使领 A-Z]{1}[A-HJ-NP-Z]{1}(([0-9]{5}[DF])|([DF][A-HJ-NP-Z0-9][0-9]{4}))$/g.test(value);

/**
 *  验证车牌号(非新能源)
 * @param { string } value
 */
export const isLicensePlateNumberNNER = (value: string) => /^[京津沪渝冀豫云辽黑湘皖鲁新苏浙赣鄂桂甘晋蒙陕吉闽贵粤青藏川宁琼使领 A-Z]{1}[A-HJ-NP-Z]{1}[A-Z0-9]{4}[A-Z0-9挂学警港澳]{1}$/g.test(value);
 ...
 * @param { string } value
 */
export const isMPMostRelaxed = (value: string) => /^(?:(?:\+|00)86)?1\d{10}$/g.test(value);
 ...
 * @param { string } value
 */
export const isIDCardOld = (value: string) => /^[1-9]\d{7}(?:0\d|10|11|12)(?:0[1-9]|[1-2][\d]|30|31)\d{3}$/g.test(value);

/**
 *  验证身份证号(2代,18位数字),最后一位是校验位,可能为数字或字符X
 * @param { string } value
 */
export const isIDCardNew = (value: string) => /^[1-9]\d{5}(?:18|19|20)\d{2}(?:0\d|10|11|12)(?:0[1-9]|[1-2]\d|30|31)\d{3}[\dXx]$/g.test(value);
 ...
 * @param { string } value
 * @example -11.00
 * isDecimal('-111.00') //=> true
 * isDecimal('111.0') //=> true
 * isDecimal('-111') //=> false
 */
 ...
 * @param { string } value
 */
export const isHTMLtags = (value: string) => /<(\w+)[^>]*>(.*?<\/\1>)?/g.test(value);

/**
 * 验证qq号格式正确
 * @param { string } value
 */
export const isQQNum = (value: string) => /^[1-9][0-9]{4,10}$/g.test(value);
 ...
 * @param { string } value
 */
export const isIPv4 = (value: string) => /^(?:(?:25[0-5]|2[0-4][0-9]|[01]?[0-9][0-9]?)\.){3}(?:25[0-5]|2[0-4][0-9]|[01]?[0-9][0-9]?)$/g.test(value);

/**
 * 验证ip-v6
 * @param { string } value
 */
export const isIPv6 = (value: string) => /^((([0-9A-Fa-f]{1,4}:){7}[0-9A-Fa-f]{1,4})|(([0-9A-Fa-f]{1,4}:){6}:[0-9A-Fa-f]{1,4})|(([0-9A-Fa-f]{1,4}:){5}:([0-9A-Fa-f]{1,4}:)?[0-9A-Fa-f]{1,4})|(([0-9A-Fa-f]{1,4}:){4}:([0-9A-Fa-f]{1,4}:){0,2}[0-9A-Fa-f]{1,4})|(([0-9A-Fa-f]{1,4}:){3}:([0-9A-Fa-f]{1,4}:){0,3}[0-9A-Fa-f]{1,4})|(([0-9A-Fa-f]{1,4}:){2}:([0-9A-Fa-f]{1,4}:){0,4}[0-9A-Fa-f]{1,4})|(([0-9A-Fa-f]{1,4}:){6}((\b((25[0-5])|(1\d{2})|(2[0-4]\d)|(\d{1,2}))\b)\.){3}(\b((25[0-5])|(1\d{2})|(2[0-4]\d)|(\d{1,2}))\b))|(([0-9A-Fa-f]{1,4}:){0,5}:((\b((25[0-5])|(1\d{2})|(2[0-4]\d)|(\d{1,2}))\b)\.){3}(\b((25[0-5])|(1\d{2})|(2[0-4]\d)|(\d{1,2}))\b))|(::([0-9A-Fa-f]{1,4}:){0,5}((\b((25[0-5])|(1\d{2})|(2[0-4]\d)|(\d{1,2}))\b)\.){3}(\b((25[0-5])|(1\d{2})|(2[0-4]\d)|(\d{1,2}))\b))|([0-9A-Fa-f]{1,4}::([0-9A-Fa-f]{1,4}:){0,5}[0-9A-Fa-f]{1,4})|(::([0-9A-Fa-f]{1,4}:){0,6}[0-9A-Fa-f]{1,4})|(([0-9A-Fa-f]{1,4}:){1,7}:))$/i.test(value);
